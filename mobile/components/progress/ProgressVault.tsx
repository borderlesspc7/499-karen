    ...
    <ThemedScreen>
      ...
      >
        <View className="gap-3">
          ...
          <Text className="text-3xl font-bold text-white">{t('progress.title')}</Text>
          <Text className="text-sm leading-5 text-white/60">{t('progress.subtitle')}</Text>
        </View>

        <View className="flex-row gap-3">
          <View className="flex-1 rounded-2xl border border-white/10 bg-white/5 p-4">
            <Text className="text-xs text-white/50">{t('progress.level')}</Text>
            <Text className="mt-1 text-xl font-bold text-gold">
              Level {level}
            </Text>
          </View>
          <View className="flex-1 rounded-2xl border border-white/10 bg-white/5 p-4">
            <Text className="text-xs text-white/50">{t('progress.tier')}</Text>
            <Text className="mt-1 text-sm font-bold text-white">{companyTier}</Text>
          </View>
          <View className="flex-1 rounded-2xl border border-white/10 bg-white/5 p-4">
            <Text className="text-xs text-white/50">{t('progress.coins')}</Text>
        ...
        <View className="gap-4">
          <View className="flex-row items-center gap-2">
            ...
            <Text className="text-lg font-bold text-white">{t('progress.timeline')}</Text>
          </View>
